...
'   <body style="height: 100%; margin: 0">\n' +
'       <div id="container" style="height: 100%"></div>\n' +
'       <script type="text/javascript" src="' + applicationPath + '/Echart/javascripts/echarts-all-3.js"></script>\n' +
'       <script type="text/javascript" src="' + applicationPath + '/Echart/javascripts/ecStat.min.js"></script>\n' +
'       <script type="text/javascript" src="' + applicationPath + '/Echart/javascripts/dataTool.min.js"></script>\n' +
//'       <script type="text/javascript" src="' + applicationPath + '/Echart/javascripts/china.js"></script>\n' +
//'       <script type="text/javascript" src="' + applicationPath + '/Echart/javascripts/world.js"></script>\n' +
//'       <script type="text/javascript" src="' + applicationPath + '/Echart/javascripts/api.map.js"></script>\n' +
//'       <script type="text/javascript" src="' + applicationPath + '/Echart/javascripts/bmap.min.js"></script>\n' +
