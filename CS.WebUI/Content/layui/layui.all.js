        ...
        d = {
            select: function() {
                ...
                h = function(t, u, f) {
                    ...
                    if (!u) {
                        var C = function() {
                            ...
                            e + i > y.height() && e >= i && t.addClass(a + "up")
                        },
                        w = function(e) {
                        ...
                        function(e) {
                            ...
                            var t = function(i, a) {
                                ...
                                } (), l = a[i](), n = a[i]("dd"), l[0]) return h = a[i](),
                                !n[0] || n.hasClass(o) ? t(i, h) : void n.addClass(s).siblings().removeClass(s)
                            };
                            38 === i && t("prev"),
                            40 === i && t("next"),
                        ...
                        var $ = function(e, t, a) {
                            ...
                            function() {
                                ...
                                "keyup" === a && t[r ? "addClass": "removeClass"](c)
                            });
                            var l = n === x.length;
                            return t(l),
                            l
                ...
                f.each(function(e, l) {
                    ...
                    m = i(['<div class="' + (y ? "": "layui-unselect ") + a, (u ? " layui-select-disabled": "") + '">', '<div class="' + n + '">', '<input type="text" placeholder="' + p + '" ' + ('value="' + (d ? f.html() : "") + '"') + (y ? "": " readonly") + ' class="layui-input' + (y ? "": " layui-unselect") + (u ? " " + o: "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (r.find("optgroup")[0] ? " layui-select-group": "") + '">',
                    function(e) {
                        var i = [];
                        return layui.each(e,
                        function(e, a) {
            ...
            checkbox: function() {
                ...
                t.each(function(t, n) {
                    ...
                    var d = l.next("." + u[0]),
                    f = i(['<div class="layui-unselect ' + u[0], n.checked ? " " + u[1] : "", c ? " layui-checkbox-disbaled " + o: "", '"', r ? ' lay-skin="' + r + '"': "", ">",
                    function() {
                        var e = n.title.replace(/\s/g, ""),
                        i = {
                            checkbox: [e ? "<span>" + n.title + "</span>": "", '<i class="layui-icon layui-icon-zhengque"></i>'].join(""),
        ...
        function(e, l) {
            ...
            function(e, i) {
                ...
                if (a[i]) {
                    ...
                    if (f = f || a[i][1], o) return "tips" === u ? t.tips(f,
                    function() {
