...
(function ($) {
    ...
    var checkboxSetting = {
        ...
        callback: {
            onCheck: checkNode,
            onSuccess: onAsyncSuccess
        }
    };

    function onAsyncSuccess(event, treeId, treeNode,msg) {
        var f ="D68568137463679529C6C13228E29500";//所选的ID   例如 "12589"
    ...
    function checkNode(event, treeId, treeNode) {
        ...
        //多选
            ...
            var searchCondition = $.trim($('#' + searchId).val());
            if (searchCondition != "") {
    ...
    function createDropDownDom($inputValue, cyProps) {
        ...
        var ztreeId = ztreeType + "-" + nowTime + $(".ztree").length;
         searchId = "search_condition-" + nowTime + $(".search_condition").length;
        /** 输入框**/
        var inputHtml =
            $inputValue.html([
                '<input type="hidden" id="' + _name+'_values" class="form-input" name="' + _name + '" value="' + _value + '">',
