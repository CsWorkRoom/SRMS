...
function sysCsFlowSave(mainTableKey) {
    layui.use(['form', 'layer', 'jquery'], function () {
        ...
        var formFd = {
            SysCsFlowCaseID: $("#SysCsFlowCaseID").val(),
            SysCsFirstFlowNodeCaseID: $("#SysCsFirstFlowNodeCaseID").val(),
            sysCsMainTableKey: mainTableKey
        }
        var url = "../AfFlowCase/ProcessCreate";
...
function FlowSubmit() {
    layui.use(['form', 'layer', 'jquery', 'laydate', 'table', 'element'], function () {
        ...
        //#region 调用子页面约定函数
        var data= $("#FlowMainPage")[0].contentWindow.SaveFlowForm();//调用子页面提交函数获得主键信息
        //#endregion
        //#endregion
