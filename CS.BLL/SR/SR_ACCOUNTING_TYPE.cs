...
namespace CS.BLL.SR
{
    ...
    /// 会计类型
    /// </summary>
    public class SR_ACCOUNTING_TYPE : BBaseQuery
    {
        /// <summary>
        /// 单例
        /// </summary>
        public static SR_ACCOUNTING_TYPE Instance = new SR_ACCOUNTING_TYPE();

        /// <summary>
        /// 构造函数
        /// </summary>
        public SR_ACCOUNTING_TYPE()
        {
            this.IsAddIntoCache = true;
            this.TableName = "SR_ACCOUNTING_TYPE";
            this.ItemName = "会计类型";
            this.KeyField = "ID";
