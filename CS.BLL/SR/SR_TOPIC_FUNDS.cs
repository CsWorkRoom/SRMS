...
namespace CS.BLL.SR
{
    ...
    /// 经费报销总表
    /// </summary>
    public class SR_TOPIC_FUNDS : BBaseQuery
    {
        /// <summary>
        /// 单例
        /// </summary>
        public static SR_TOPIC_FUNDS Instance = new SR_TOPIC_FUNDS();

        /// <summary>
        /// 构造函数
        /// </summary>
        public SR_TOPIC_FUNDS()
        {
            this.IsAddIntoCache = true;
            this.TableName = "SR_TOPIC_FUNDS";
            this.ItemName = "经费报销总表";
            this.KeyField = "ID";
